...
x = [ones(length(tNordOvest.NO_DIABETE(1:end-4,:)),1) tNordOvest.NO_DIABETE(1:end-4,:) tNordOvest.NO_MA_ALLERGICHE(1:end-4,:) tNordOvest.NO_ECCESSO_PESO(1:end-4,:)];
y = tNordOvest.NO_IPERTENSIONE(1:end-4,:);
...
x_regDin = [ones(length(tNordOvest.NO_DIABETE(1:end-4,:)),1) tNordOvest.NO_DIABETE(1:end-4,:) tNordOvest.NO_MA_ALLERGICHE(1:end-4,:) tNordOvest.NO_ECCESSO_PESO(1:end-4,:)];
x_last5 = [ones(length(tNordOvest.NO_DIABETE(end-4:end,:)),1) tNordOvest.NO_DIABETE(end-4:end,:) tNordOvest.NO_MA_ALLERGICHE(end-4:end,:) tNordOvest.NO_ECCESSO_PESO(end-4:end,:)];
...
x = [tNordOvest.NO_DIABETE(1:end-4,:) tNordOvest.NO_MA_ALLERGICHE(1:end-4,:)];
y = tNordOvest.NO_IPERTENSIONE(1:end-4,:);
