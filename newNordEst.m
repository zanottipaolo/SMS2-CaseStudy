...
funzioneMap = @(params) map(params, x1, NE_lm1.Coefficients.Estimate(1), NE_lm1.Coefficients.Estimate(2), NE_lm1.Coefficients.Estimate(3), NE_lm1.Coefficients.Estimate(4));
modelNE = ssm(funzioneMap)
...
x_last5 = [tNordEst.NE_MA_ALLERGICHE(end-4:end,:) tNordEst.NE_DIABETE(end-4:end,:)];
